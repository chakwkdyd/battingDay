...
$(function(){
	...
	function Validation(){
        ...
        if( $('input[name=user_pw]').val() == "")		{ alert('비밀번호를 입력하세요');return;}
        if( $('input[name=user_name]').val() == "")		{ alert('이름을 입력하세요');return;}
        if( $('input[name=user_gender]').val() == "")	{ alert('성별을 선택해 주세요.');return;}
        if( $('input[name=date_y]').val() == "")		{ alert('생년을 입력하세요');return;}
        if( $('input[name=date_m]').val() == "")		{ alert('생월을 입력하세요');return;}
        if( $('input[name=date_d]').val() == "")		{ alert('생일을 입력하세요');return;}
        if( $('input[name=user_email]').val() == "")	{ alert('이메일을 입력하세요');return;}
        if( $('input[name=user_number]').val() == "")	{ alert('번호를 입력하세요');return;}
        if( $('input[name=user_adress]').val() == "")	{ alert('주소를 입력하세요');return;}
...
<body>
	...
	<form id="frm" action="/member/join.do" method="post">
		...
		<table border="1">
			...
			<tr><td style="text-align: center; background-color: #B4FFFF;">비밀번호 재확인</td></tr>
			<tr>
				<td>
					<input type="password" id="pw2" class="pw" onchange="isSame()">
					<br>
					<input type="text" id="pwResult" style="width: 100%;">
				</td>
			</tr>
			
			<tr><td style="text-align: center; background-color: #B4FFFF;">이름</td></tr>
			<tr>
				<td>
			...
			<tr><td style="text-align: center; background-color: #B4FFFF;">생년월일</td></tr>
			<tr>
				<td>
					<input type="text" style="width: 100px;" placeholder="년(4자)" name="date_y">
					
					<select style="width: 100px;" name="date_m">
						<option>월</option>
						<option>01</option>
						<option>02</option>
						<option>03</option>
					...
					<input type="text" style="width: 100px;" placeholder="일" name="date_d">
					
					
				<div></div><!-- 태어난 년도 4자리를 정확하게 입력하세요.  태어난 일(날짜) 2자리를 정확하게 입력하세요. -->
				</td>
			</tr>
			
			<tr><td style="text-align: center; background-color: #B4FFFF;">성별</td></tr>
			<tr>
				<td>
					<select style="width: 100px;" name="user_gender">
			...
			<tr><td style="text-align: center; background-color: #B4FFFF;">주소</td></tr>
			<tr>
				<td>
					<div class="form-group">
				        <input type="hidden" id="all_dress" name="user_adress">
					...
					<div class="form-group">
					    <input class="form-control" style="top: 5px;" placeholder="도로명 주소"  id="addr2" type="text" readonly="readonly" />
					</div>
					<div class="form-group">
			...
			<tr><td style="text-align: center; background-color: #B4FFFF;">휴대전화</td></tr>
			<tr>
				<td>
				...
				<br>
					<input type="text" placeholder="전화번호  입력" name="user_number">
			...
			<tr>
				<td>
					<input type="email" placeholder="이메일을 입력해주세요" name="user_email">
				</td>
			</tr>
			
			<tr>
				<td style="text-align: center; background-color: #B4FFFF;">
